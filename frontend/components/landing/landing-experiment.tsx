...
const landingCopy = {
  ...
  ar: {
    ...
    hero: {
      ...
      primary: "قرّب المعنى",
      secondary: "اكتشف ما يقدّمه وضّح",
    ...
    about: {
      kicker: "فكرة وضّح",
      titleBefore: "نفكّ تعقيد النص،",
      titleCloser: "لا معناه.",
      titleMiddle: "",
      titleLearn: "",
      points: [
        "لا نأخذك بعيداً عن النص؛ نقرّبك منه.",
        "نوضّح ما يصعب، ونحافظ على ما يهم.",
        "احفظ الكلمات التي صادفتها، وارجع إليها حين تحتاجها.",
      ],
    },
    reading: {
      kicker: "داخل القراءة",
      title: "لا نستبدل النص؛",
      accent: "نفتح لك طريقه.",
    ...
    philosophy: {
      ...
      learning: "التعلّم",
      mapKicker: "تعلّمي",
      mapTitle: "كل نص تفهمه، يصبح جزءاً من لغتك.",
      ...
      understandTitle: "حين يصعب المعنى، تجد ما يقرّبه.",
